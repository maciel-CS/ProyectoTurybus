...
GO
PRINT N'Creating Table [dbo].[ActividadTuristica]...';
...
GO
PRINT N'Creating Table [dbo].[Autobus]...';
...
CREATE TABLE [dbo].[Autobus] (
    ...
    [Descripcion_caracteristicas] VARCHAR (MAX) NULL,
    [rowversion]                  TIMESTAMP     NOT NULL,
    PRIMARY KEY CLUSTERED ([id] ASC),
    CONSTRAINT [UQ_Autobus_Matricula] UNIQUE NONCLUSTERED ([Matricula] ASC)
);


GO
PRINT N'Creating Table [dbo].[Boleto]...';
...
GO
PRINT N'Creating Table [dbo].[Conductor]...';
...
GO
PRINT N'Creating Table [dbo].[DetalleServicio]...';
...
GO
PRINT N'Creating Table [dbo].[LugarTuristico]...';
...
GO
PRINT N'Creating Table [dbo].[Reparacion]...';
...
GO
PRINT N'Creating Index [dbo].[Reparacion].[IX_Reparacion_id_revision]...';


GO
CREATE NONCLUSTERED INDEX [IX_Reparacion_id_revision]
    ON [dbo].[Reparacion]([id_revision] ASC);


GO
PRINT N'Creating Table [dbo].[Revision]...';
...
GO
PRINT N'Creating Index [dbo].[Revision].[IX_Revision_id_autobus]...';


GO
CREATE NONCLUSTERED INDEX [IX_Revision_id_autobus]
    ON [dbo].[Revision]([id_autobus] ASC);


GO
PRINT N'Creating Table [dbo].[RutaTuristica]...';


GO
CREATE TABLE [dbo].[RutaTuristica] (
    [Id]               INT             IDENTITY (1, 1) NOT NULL,
    [tiempo_viaje]     TIME (7)        NOT NULL,
    [id_lugarOrigen]   INT             NOT NULL,
    [id_lugarDestino]  INT             NOT NULL,
    [Costo_Transporte] DECIMAL (10, 2) NOT NULL,
    [tiempoParada]     TIME (7)        NOT NULL,
    [rowversion]       TIMESTAMP       NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
CREATE TABLE [dbo].[Servicio] (
    ...
    [id_autobus]       INT           NOT NULL,
    [Dias_programados] VARCHAR (100) NULL,
    [rowversion]       TIMESTAMP     NOT NULL,
    PRIMARY KEY CLUSTERED ([id] ASC)
);
...
GO
PRINT N'Creating Table [dbo].[ServicioAdquirido]...';
...
GO
PRINT N'Creating Table [dbo].[Turista]...';
...
GO
PRINT N'Creating Foreign Key [dbo].[FK_Boleto_ServicioAdquirido]...';


GO
ALTER TABLE [dbo].[Boleto] WITH NOCHECK
    ADD CONSTRAINT [FK_Boleto_ServicioAdquirido] FOREIGN KEY ([id_ServicioAdquirido]) REFERENCES [dbo].[ServicioAdquirido] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_DetalleServicio_ServicioAdquirido]...';


GO
ALTER TABLE [dbo].[DetalleServicio] WITH NOCHECK
    ADD CONSTRAINT [FK_DetalleServicio_ServicioAdquirido] FOREIGN KEY ([id_servicioAdquirido]) REFERENCES [dbo].[ServicioAdquirido] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_DetalleServicio_ActividadTuristica]...';


GO
ALTER TABLE [dbo].[DetalleServicio] WITH NOCHECK
    ADD CONSTRAINT [FK_DetalleServicio_ActividadTuristica] FOREIGN KEY ([id_ActividadTuristica]) REFERENCES [dbo].[ActividadTuristica] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_reparacion_revision]...';


GO
ALTER TABLE [dbo].[Reparacion] WITH NOCHECK
    ADD CONSTRAINT [FK_reparacion_revision] FOREIGN KEY ([id_revision]) REFERENCES [dbo].[Revision] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_revision_autobus]...';


GO
ALTER TABLE [dbo].[Revision] WITH NOCHECK
    ADD CONSTRAINT [FK_revision_autobus] FOREIGN KEY ([id_autobus]) REFERENCES [dbo].[Autobus] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_RutaTuristica_LugarOrigen]...';


GO
ALTER TABLE [dbo].[RutaTuristica] WITH NOCHECK
    ADD CONSTRAINT [FK_RutaTuristica_LugarOrigen] FOREIGN KEY ([id_lugarOrigen]) REFERENCES [dbo].[LugarTuristico] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_RutaTuristica_LugarDestino]...';


GO
ALTER TABLE [dbo].[RutaTuristica] WITH NOCHECK
    ADD CONSTRAINT [FK_RutaTuristica_LugarDestino] FOREIGN KEY ([id_lugarDestino]) REFERENCES [dbo].[LugarTuristico] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Servicio_Conductor]...';


GO
ALTER TABLE [dbo].[Servicio] WITH NOCHECK
    ADD CONSTRAINT [FK_Servicio_Conductor] FOREIGN KEY ([id_conductor]) REFERENCES [dbo].[Conductor] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Servicio_Autobus]...';


GO
ALTER TABLE [dbo].[Servicio] WITH NOCHECK
    ADD CONSTRAINT [FK_Servicio_Autobus] FOREIGN KEY ([id_autobus]) REFERENCES [dbo].[Autobus] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_Servicio_RutasTuristicas]...';


GO
ALTER TABLE [dbo].[Servicio] WITH NOCHECK
    ADD CONSTRAINT [FK_Servicio_RutasTuristicas] FOREIGN KEY ([id_ruta]) REFERENCES [dbo].[RutaTuristica] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_ServicioAdquirido_Servicio]...';


GO
ALTER TABLE [dbo].[ServicioAdquirido] WITH NOCHECK
    ADD CONSTRAINT [FK_ServicioAdquirido_Servicio] FOREIGN KEY ([id_Servicio]) REFERENCES [dbo].[Servicio] ([id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_ServicioAdquirido_Turista]...';


GO
ALTER TABLE [dbo].[ServicioAdquirido] WITH NOCHECK
    ADD CONSTRAINT [FK_ServicioAdquirido_Turista] FOREIGN KEY ([id_Turista]) REFERENCES [dbo].[Turista] ([id]);


GO
PRINT N'Creating Procedure [dbo].[GeAutobusChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetActividadTuristicaChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetBoletoChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetConductorChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetDetalleServicioChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetLugarTuristicoChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetReparacionChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetRevisionChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetRutaTuristicaChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetServicioAdquiridoChangesByRowVersion]...';
...
BEGIN
  ...
  select ser.Id IdServicio , SUM(rut.Costo_Transporte) TotalCostoTransporte
  into #ServicioCostoTransporte
  from RutaTuristica rut
  join Servicio ser on ser.id_ruta = rut.Id
  WHERE (ser.[rowversion] > CONVERT(ROWVERSION,@startRow) 
		AND ser.[rowversion] <= CONVERT(ROWVERSION,@endRow))
  OR (rut.[rowversion] > CONVERT(ROWVERSION,@startRow) 
		AND rut.[rowversion] <= CONVERT(ROWVERSION,@endRow))
  Group by ser.ID;

  select ser.Id IdServicio , SUM(act.Costo_Actividad) TotalCostoActividad
 into #ServicioCostoActividad
  from ActividadTuristica act
  join RutaTuristica  rut on  rut.Id = act.id_RutaTuristica
  join Servicio ser on ser.id_ruta = rut.Id
  WHERE (ser.[rowversion] > CONVERT(ROWVERSION,@startRow) 
		AND ser.[rowversion] <= CONVERT(ROWVERSION,@endRow))
 ...
 into #ServicioListaActividad
  ...
  select costAct.IdServicio ,sum (costTrans.TotalCostoTransporte + costAct.TotalCostoActividad) CostoTotal,
  sum (costTrans.TotalCostoTransporte + costAct.TotalCostoActividad)*.30 PrecioTotal
  into #costoTotalServicio
  from #ServicioCostoTransporte costTrans
  join #ServicioCostoActividad  costAct on costTrans.IdServicio = costAct.IdServicio
  Group by costAct.IdServicio 
  ...
  ser.id_autobus ,
  ser.id_ruta ,
  costtot.PrecioTotal PrecioPaquete ,
  costtot.CostoTotal CostoServicio ,
  serAd.id_Turista ,
  ...
  ListAct.ListaActividad 
	...
	drop table if exists #ServicioCostoTransporte;
	drop table if exists #ServicioCostoActividad
	drop table if exists #ServicioListaActividad
	drop table if exists #costoTotalServicio
END
GO
PRINT N'Creating Procedure [dbo].[GetServicioChangesByRowVersion]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[GetTuristaChangesByRowVersion]...';
...
GO
ALTER TABLE [dbo].[Boleto] WITH CHECK CHECK CONSTRAINT [FK_Boleto_ServicioAdquirido];

ALTER TABLE [dbo].[DetalleServicio] WITH CHECK CHECK CONSTRAINT [FK_DetalleServicio_ServicioAdquirido];

ALTER TABLE [dbo].[DetalleServicio] WITH CHECK CHECK CONSTRAINT [FK_DetalleServicio_ActividadTuristica];

ALTER TABLE [dbo].[Reparacion] WITH CHECK CHECK CONSTRAINT [FK_reparacion_revision];

ALTER TABLE [dbo].[Revision] WITH CHECK CHECK CONSTRAINT [FK_revision_autobus];

ALTER TABLE [dbo].[RutaTuristica] WITH CHECK CHECK CONSTRAINT [FK_RutaTuristica_LugarOrigen];

ALTER TABLE [dbo].[RutaTuristica] WITH CHECK CHECK CONSTRAINT [FK_RutaTuristica_LugarDestino];

ALTER TABLE [dbo].[Servicio] WITH CHECK CHECK CONSTRAINT [FK_Servicio_Conductor];

ALTER TABLE [dbo].[Servicio] WITH CHECK CHECK CONSTRAINT [FK_Servicio_Autobus];

ALTER TABLE [dbo].[Servicio] WITH CHECK CHECK CONSTRAINT [FK_Servicio_RutasTuristicas];

ALTER TABLE [dbo].[ServicioAdquirido] WITH CHECK CHECK CONSTRAINT [FK_ServicioAdquirido_Servicio];

ALTER TABLE [dbo].[ServicioAdquirido] WITH CHECK CHECK CONSTRAINT [FK_ServicioAdquirido_Turista];
