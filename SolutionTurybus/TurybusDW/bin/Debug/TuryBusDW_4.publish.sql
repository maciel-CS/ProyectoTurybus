...
GO
/*
The column [dbo].[FactServicioAdquirido].[ActividadTuristicaSK] is being dropped, data loss could occur.
*/
...
GO
/*
The column [staging].[ServicioAdquirido].[ActividadTuristicaSK] is being dropped, data loss could occur.
*/
...
GO
PRINT N'Altering Table [dbo].[FactServicioAdquirido]...';


GO
ALTER TABLE [dbo].[FactServicioAdquirido] DROP COLUMN [ActividadTuristicaSK];


GO
PRINT N'Altering Table [staging].[ServicioAdquirido]...';


GO
ALTER TABLE [staging].[ServicioAdquirido] DROP COLUMN [ActividadTuristicaSK];
