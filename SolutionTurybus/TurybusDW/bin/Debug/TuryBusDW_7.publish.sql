...
GO
/*
The column [dbo].[FactServicioAdquirido].[ServicioAdquiridoSK] is being dropped, data loss could occur.
*/
...
GO
/*
The column [staging].[ServicioAdquirido].[TuristaSK] is being dropped, data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[FactServicioAdquirido] DROP COLUMN [ServicioAdquiridoSK];
...
GO
ALTER TABLE [staging].[ServicioAdquirido] DROP COLUMN [TuristaSK];
